            ...
            <div key={item.id} className="flex items-center mb-4">
              ...
              <div className="flex-grow">
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">{item.quantity} × {item.price.toLocaleString()} تومان</span>
                  <span className="text-sm font-medium">{(item.price * item.quantity).toLocaleString()} تومان</span>
                </div>
              </div>
            </div>
          ))}
