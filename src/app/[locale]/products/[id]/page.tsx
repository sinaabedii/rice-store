...
const PRODUCT = {
  ...
  description: 'برنج طارم یکی از مرغوب‌ترین و خوش عطرترین برنج‌های ایرانی است که در استان‌های شمالی کشور کشت می‌شود. این برنج به دلیل دانه‌های بلند و باریک، عطر و طعم منحصر به فرد و خاصیت کشیدگی عالی در هنگام پخت، از محبوبیت زیادی برخوردار است.\n\nبرنج طارم اعلای ما از بهترین مزارع استان مازندران انتخاب و با دقت فرآوری می‌شود تا کیفیت استثنایی آن حفظ شود.',
  price: 480000,
  images: [
