          ...
          <div className="container-custom">
            <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
              <div className="text-center mb-6">
                <h1 className="text-2xl font-bold text-accent mb-2">ثبت‌نام در فروشگاه</h1>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label htmlFor="password" className="block text-gray-700 mb-1">رمز عبور</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-500">
                      <FiLock />
                    </div>
                ...
                <div className="mb-6">
                  <label htmlFor="confirmPassword" className="block text-gray-700 mb-1">تکرار رمز عبور</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-500">
                      <FiLock />
                    </div>
                ...
                <div className="flex items-start mb-6">
                  ...
                  <label htmlFor="terms" className="mr-2 text-sm text-gray-700">
                    با <Link href="/terms" className="text-primary hover:underline">قوانین و مقررات</Link> سایت موافقم و <Link href="/privacy" className="text-primary hover:underline">حریم خصوصی</Link> را مطالعه کرده‌ام
                  </label>
                </div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 488 512">
                ...
                <div className="text-center mt-6">
                  <p className="text-gray-700">
                    ...
                    <Link href="/account/login" className="text-primary mr-1 hover:underline">
                      وارد شوید
                    </Link>
                  </p>
                </div>
