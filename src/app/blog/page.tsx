...
const BLOG_POSTS = [
  {
    ...
    excerpt: 'در این مقاله به معرفی انواع مختلف برنج ایرانی از جمله طارم، هاشمی، دم سیاه و علی کاظمی می‌پردازیم و تفاوت‌های آن‌ها را بررسی می‌کنیم.',
  ...
  },
  {
    ...
    excerpt: 'چگونه برنج اصل و با کیفیت را از نمونه‌های تقلبی تشخیص دهیم؟ در این مقاله روش‌های ساده و کاربردی برای تشخیص برنج مرغوب را به شما آموزش می‌دهیم.',
  ...
  },
  {
    ...
    excerpt: 'آموزش گام به گام پخت کته برنج ایرانی به روشی که دانه‌ها کاملاً جدا از هم و خوش عطر و طعم باشند. ترفندهای طلایی آشپزهای حرفه‌ای را یاد بگیرید.',
  ...
  },
  {
    ...
    excerpt: 'آشنایی با تاریخ و فرهنگ کشت برنج در استان‌های شمالی ایران. چگونه مردمان شمال، هزاران سال است که با این محصول زندگی می‌کنند و آن را پرورش می‌دهند؟',
    image: '/images/blog/rice-history.jpg',
    author: 'علی محمدی',
    date: '۱۴۰۱/۱۲/۱۰',
    category: 'تاریخی',
  ...
  },
  {
    ...
    excerpt: 'برنج چه ارزش غذایی دارد و چرا هنوز پس از قرن‌ها، یکی از اصلی‌ترین مواد غذایی در سفره‌های ایرانی است؟ در این مقاله به بررسی ارزش تغذیه‌ای برنج می‌پردازیم.',
  ...
  },
  {
    ...
    excerpt: 'کشاورزان شمال با چه مشکلاتی در کشت برنج مواجه هستند؟ از تغییرات اقلیمی تا مشکلات اقتصادی. چگونه می‌توان از کشاورزان حمایت کرد؟',
    image: '/images/blog/rice-farmers.jpg',
    author: 'رضا حسینی',
    date: '۱۴۰۱/۰۹/۲۰',
    category: 'اقتصادی',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {BLOG_POSTS.map((post) => (
                  <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:transform hover:scale-[1.02] duration-300">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                {/* Categories */}
                <div className="bg-white rounded-lg shadow-md p-4">
                  <h3 className="text-lg font-semibold text-accent mb-4">دسته‌بندی‌ها</h3>
                ...
                {/* Recent Posts */}
                <div className="bg-white rounded-lg shadow-md p-4">
                  <h3 className="text-lg font-semibold text-accent mb-4">آخرین مطالب</h3>
                ...
                <div className="bg-white rounded-lg shadow-md p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {Array.from(new Set(BLOG_POSTS.flatMap(post => post.tags))).map((tag, index) => (
                      <Link 
                        key={index} 
                        href={`/blog/tag/${tag}`} 
