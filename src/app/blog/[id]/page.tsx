...
const RELATED_POSTS = [
  ...
  },
  {
    ...
    excerpt:
      "آموزش گام به گام پخت کته برنج ایرانی به روشی که دانه‌ها کاملاً جدا از هم باشند.",
  ...
  },
  {
    ...
    excerpt:
      "برنج چه ارزش غذایی دارد و چرا هنوز پس از قرن‌ها، یکی از اصلی‌ترین مواد غذایی است؟",
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          کارشناس کنترل کیفیت برنج
                        </p>
                      </div>
                    </div>
                    <p className="text-gray-700">
                      متخصص در زمینه کنترل کیفیت محصولات کشاورزی با بیش از ۱۵
                      سال سابقه در صنعت برنج. دارای مدرک کارشناسی ارشد علوم و
                      صنایع غذایی و عضو انجمن متخصصان صنایع غذایی ایران.
                    </p>
                  </div>
                </div>
              </article>
                  ...
                  <div className="border-b pb-6">
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-gray-700">
                          مقاله بسیار مفیدی بود. من همیشه در انتخاب نوع برنج
                          مناسب سردرگم بودم اما با خواندن این مقاله، تفاوت‌های
                          انواع برنج ایرانی را بهتر متوجه شدم. ممنون از اطلاعات
                          کاربردی.
                        </p>
                    ...
                    <div className="flex items-start mr-16 mt-4">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-gray-700">
                          سلام محمد عزیز، خوشحالم که مقاله برای شما مفید بوده
                          است. امیدوارم با این اطلاعات بتوانید انتخاب بهتری
                          داشته باشید.
                        </p>
                        <button className="text-primary text-sm mt-2 hover:underline">
                          پاسخ
                  ...
                  <div>
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-gray-700">
                          آیا می‌توانید در مورد نحوه نگهداری انواع مختلف برنج هم
                          مقاله‌ای بنویسید؟ مثلاً اینکه چه مدت می‌توان برنج را
                          نگهداری کرد و بهترین شرایط نگهداری چیست؟
                        </p>
                        <button className="text-primary text-sm mt-2 hover:underline">
                          پاسخ
                        </button>
            ...
            <div>
              <div className="space-y-6">
                ...
                <div className="bg-accent text-white rounded-lg shadow-md p-6">
                  ...
                  <p className="mb-4">
                    برنج‌های اصیل و خوش عطر شمال را با کیفیت تضمینی، مستقیم از
                    کشاورز خریداری کنید.
                  </p>
                  <Link
                    href="/products"
